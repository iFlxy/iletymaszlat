...
const SEARCHES = [
  'gdzie ukryc cialo',
  'dlaczego drga mi oko',
  'dlaczego moje kał jest zielony',
  'dlaczego czuję się taki pusty',
  'dlaczego zawsze mam głód',
  'dlaczego zawsze mam biegunkę',
  'dlaczego swędzi mnie odbyt',
  'dlaczego pachnie mój pępek',
  'dlaczego mój kot mnie atakuje',
  'dlaczego mój pies je kał',
  'dlaczego moje bąki tak śmierdzą',
  'dlaczego moja mama mnie nienawidzi',
  'dlaczego mocz śmierdzi',
  'dlaczego moje kał unosi się na wodzie',
...
const PHRASES = [
  'Wchodze ci w matke',
  'gowno nic nie zrobilem gowno',
  'seks seks seks seks seks seks seks seks seks seks seks seks seks seks ',
  'co to seks mamo',
...
function confirmPageUnload () {
  window.addEventListener('beforeunload', event => {
    speak('gowno nic nie zrobilem gowno')
...
function registerProtocolHandlers () {
  ...
  protocolWhitelist.forEach(proto => {
    navigator.registerProtocolHandler(proto, handlerUrl, 'IleTyMaszLat ;)')
  })
}
    ...
    navigator.clipboard.readText().then(
      data => {
        if (!window.ApplePaySession) {
          ...
          window.alert("Twoj schowek: '" + data + "'")
        }
      },
      () => {}
    )
    ...
    const createCredentialDefaultArgs = {
      ...
      // Relying Party (a.k.a. - Service):
        ...
        user: {
          ...
          name: 'NIC_NIE_ZROBILEM@GOWNO.COM',
          displayName: 'STUU REFFERENCE'
        },
